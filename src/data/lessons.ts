...
import { itA1Lessons } from "./it-a1-lessons";
import { itA2Lessons } from "./it-a2-lessons";
import { itB1Lessons } from "./it-b1-lessons";
import { itB2Lessons } from "./it-b2-lessons";
import { itC1Lessons } from "./it-c1-lessons";
import { itC2Lessons } from "./it-c2-lessons";
...
import { arDrawingLessonsP4 } from "./ar-drawing-lessons-p4";
...
const baseLessons: Record<string, LessonData> = {
  ...
  "a1-1": {
    ...
    vocabulary: [
      ...
      { word: "Welcome", meaning: "A greeting to someone arriving", example: "Welcome to our school!", emoji: "🏫", arabic: "أهلاً" },
      { word: "Fine", meaning: "Feeling OK, good", example: "I'm fine, thank you.", emoji: "👍", arabic: "بخير" },
      { word: "Excuse me", meaning: "A polite way to get attention", example: "Excuse me, where is the door?", emoji: "🙋", arabic: "عفواً / لو سمحت" },
      { word: "How", meaning: "Used to ask about condition", example: "How are you?", emoji: "❓", arabic: "كيف" },
      { word: "Good morning", meaning: "A greeting used in the morning", example: "Good morning, teacher!", emoji: "🌅", arabic: "صباح الخير" },
    ],
    dialogue: [
      { speaker: "Tom", text: "Good morning! My name is Tom. What's your name?" },
      { speaker: "Lisa", text: "Hi! I'm Lisa. Nice to meet you, Tom!" },
      { speaker: "Tom", text: "Nice to meet you too! How are you today?" },
      { speaker: "Lisa", text: "I'm fine, thank you! And you?" },
      { speaker: "Tom", text: "I'm great! Where are you from?" },
      ...
      { speaker: "Tom", text: "See you in class! Goodbye!" },
      { speaker: "Lisa", text: "Goodbye, Tom! See you later!" },
    ],
    grammar: {
      title: "The Verb 'To Be' — Present Simple",
      explanation: "The verb 'to be' is the most important verb in English. It changes form depending on the subject: I am, you are, he/she/it is, we/they are. We use it to describe identity, feelings, and states. Short forms: I'm, you're, he's, she's, it's, we're, they're.",
      examples: [
        ...
        { sentence: "I'm from Egypt.", note: "Short form: I'm = I am" },
        { sentence: "They're students.", note: "Short form: They're = They are" },
      ],
    },
    vocabExercises: [
      ...
      { question: "'Good morning' is used in the:", options: ["Night", "Afternoon", "Morning", "Evening"], correct: 2 },
      { question: "'Excuse me' is a ___ way to get attention:", options: ["Rude", "Polite", "Loud", "Angry"], correct: 1 },
    ],
    conversationExercises: [
      ...
      { question: "How does Lisa feel?", options: ["Sad", "Fine", "Angry", "Tired"], correct: 1 },
    ],
    grammarExercises: [
      ...
      { question: "'I'm' is short for:", options: ["I was", "I am", "I are", "I is"], correct: 1 },
    ],
    examQuestions: [
      ...
      { question: "'Welcome' means:", options: ["Goodbye", "A greeting to someone arriving", "Sorry", "Thank you"], correct: 1 },
      { question: "The short form of 'you are' is:", options: ["you's", "you're", "your", "you"], correct: 1 },
    ],
    homeworkQuestions: [
      ...
      { question: "Write a morning greeting:", options: ["Good night!", "Good morning!", "Goodbye!", "See you!"], correct: 1 },
    ],
  },
  ...
  "b1-1": {
    ...
    vocabulary: [
      ...
      { word: "Convinced", meaning: "Completely sure about something", example: "I'm convinced this is the right choice.", emoji: "💪", arabic: "مقتنع" },
      { word: "Oppose", meaning: "To be against something", example: "Many people oppose the new law.", emoji: "🚫", arabic: "يعارض" },
      { word: "Valid", meaning: "Based on strong reasoning", example: "That's a valid concern.", emoji: "✅", arabic: "صحيح" },
      { word: "Debate", meaning: "A formal discussion of different views", example: "The debate lasted two hours.", emoji: "🎤", arabic: "نقاش" },
      { word: "Compromise", meaning: "An agreement where both sides give up something", example: "We reached a compromise.", emoji: "🤝", arabic: "حل وسط" },
    ],
    dialogue: [
      ...
      { speaker: "Mark", text: "However, some people oppose online learning because of screen time." },
      { speaker: "Sarah", text: "That's a valid concern. From my perspective, balance is key." },
      { speaker: "Mark", text: "I'm convinced that technology will keep improving education." },
      { speaker: "Sarah", text: "Let's not forget that not everyone has internet access, though." },
      { speaker: "Mark", text: "True. Perhaps a compromise would be offering both options equally." },
    ],
    grammar: {
      title: "Present Perfect — Have/Has + Past Participle",
      explanation: "We use the present perfect to talk about experiences (without saying when), recent actions with a present result, and situations that started in the past and continue now. Form: have/has + past participle (V3). Keywords: ever, never, just, already, yet, since, for.",
      examples: [
        ...
        { sentence: "I haven't seen that movie yet.", note: "'yet' in negatives — still expected" },
        { sentence: "They have already left the building.", note: "'already' — sooner than expected" },
      ],
    },
    vocabExercises: [
      ...
      { question: "'Convinced' means:", options: ["Unsure", "Completely sure", "Confused", "Angry"], correct: 1 },
      { question: "'Compromise' is when:", options: ["One side wins", "Both sides give up something", "Nobody agrees", "The debate ends badly"], correct: 1 },
    ],
    conversationExercises: [
      ...
      { question: "What compromise does Mark suggest?", options: ["Ban online learning", "Offer both options equally", "Only use textbooks", "Cancel all classes"], correct: 1 },
    ],
    grammarExercises: [
      ...
      { question: "'I haven't seen that film ___.''", options: ["already", "just", "yet", "ever"], correct: 2 },
    ],
    examQuestions: [
      ...
      { question: "'Valid' means:", options: ["Wrong", "Based on strong reasoning", "Silly", "Random"], correct: 1 },
      { question: "'Oppose' means to be:", options: ["For something", "Against something", "Neutral", "Confused"], correct: 1 },
    ],
    homeworkQuestions: [
      ...
      { question: "'They have ___ left.' (sooner than expected)", options: ["yet", "never", "already", "ever"], correct: 2 },
    ],
  },
...
export const lessons: Record<string, LessonData> = {
  ...
  ...financeCompletion,
  ...healthcareCompletion,
  ...social_mediaCompletion,
  ...engineeringCompletion,
  ...it_englishCompletion,
  ...medicalCompletion,
  ...real_lifeCompletion,
  ...slangCompletion,
  ...teensCompletion,
