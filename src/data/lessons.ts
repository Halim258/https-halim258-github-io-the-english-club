...
export const lessons: Record<string, LessonData> = {
  "reading-1": {
    ...
    vocabulary: [
      { word: "Alphabet", meaning: "The set of letters used in a language", example: "The English alphabet has 26 letters." },
      { word: "Vowel", meaning: "A, E, I, O, U — open sounds", example: "Every word needs at least one vowel." },
      { word: "Consonant", meaning: "Letters that are not vowels", example: "B, C, D are consonants." },
      { word: "Uppercase", meaning: "Capital letters (A, B, C)", example: "Start a sentence with an uppercase letter." },
      { word: "Lowercase", meaning: "Small letters (a, b, c)", example: "Most writing uses lowercase letters." },
      { word: "Letter", meaning: "A symbol in the alphabet", example: "'A' is the first letter." },
      { word: "Sound", meaning: "The noise a letter makes", example: "The letter 'B' makes a /b/ sound." },
      { word: "Word", meaning: "A group of letters with meaning", example: "'Cat' is a word with three letters." },
      { word: "Phonics", meaning: "Learning to read by sounds", example: "Phonics helps you sound out new words." },
      { word: "Read", meaning: "To understand written words", example: "I can read this book." },
    ],
    dialogue: [
  ...
  "a1-1": {
    ...
    vocabulary: [
      ...
      { word: "Name", meaning: "What you are called", example: "My name is John." },
      { word: "Please", meaning: "A polite word when asking", example: "Can I have water, please?" },
      { word: "Thank you", meaning: "Showing gratitude", example: "Thank you for helping me." },
      { word: "Yes", meaning: "Affirmative response", example: "Yes, I understand." },
      { word: "No", meaning: "Negative response", example: "No, thank you." },
      { word: "Sorry", meaning: "Expressing apology", example: "Sorry, I'm late." },
      { word: "Friend", meaning: "A person you like and trust", example: "She is my friend." },
      { word: "Nice", meaning: "Pleasant, good", example: "Nice to meet you!" },
    ],
    dialogue: [
  ...
  "a2-1": {
    ...
    vocabulary: [
      ...
      { word: "Breakfast", meaning: "The first meal of the day", example: "I have breakfast at 8 AM." },
      { word: "Commute", meaning: "Travel to work or school", example: "My commute takes 30 minutes." },
      { word: "Lunch", meaning: "The midday meal", example: "We eat lunch at noon." },
      { word: "Dinner", meaning: "The evening meal", example: "Dinner is at 7 PM." },
      { word: "Exercise", meaning: "Physical activity for health", example: "I exercise three times a week." },
      { word: "Shower", meaning: "To wash under running water", example: "I take a shower every morning." },
      { word: "Relax", meaning: "To rest and feel calm", example: "I relax in the evening." },
      { word: "Routine", meaning: "Regular activities you do each day", example: "My morning routine starts at 6 AM." },
      { word: "Schedule", meaning: "A plan of activities and times", example: "Check the schedule for class times." },
    ],
    dialogue: [
  ...
  "b1-1": {
    ...
    vocabulary: [
      { word: "Opinion", meaning: "What someone thinks about something", example: "In my opinion, this is a great movie." },
      { word: "Agree", meaning: "To have the same view", example: "I agree with you completely." },
      { word: "Disagree", meaning: "To have a different view", example: "I'm sorry, but I disagree." },
      { word: "Believe", meaning: "To think something is true", example: "I believe education is important." },
      { word: "Consider", meaning: "To think carefully about", example: "I consider this a good option." },
      { word: "Suggest", meaning: "To propose an idea", example: "I suggest we try a different approach." },
      { word: "Argument", meaning: "A reason for or against", example: "That's a strong argument." },
      { word: "Perspective", meaning: "A way of seeing things", example: "From my perspective, it makes sense." },
      { word: "Point of view", meaning: "Someone's opinion", example: "I understand your point of view." },
      { word: "Reasonable", meaning: "Fair and logical", example: "That's a reasonable idea." },
    ],
    dialogue: [
  ...
  "b2-1": {
    ...
    vocabulary: [
      { word: "Discover", meaning: "To find something for the first time", example: "Penicillin was discovered in 1928." },
      { word: "Manufacture", meaning: "To make products in a factory", example: "These cars are manufactured in Germany." },
      { word: "Construct", meaning: "To build something", example: "The bridge was constructed in 2010." },
      { word: "Establish", meaning: "To start or create officially", example: "The company was established in 1990." },
      { word: "Investigate", meaning: "To examine carefully", example: "The case is being investigated." },
      { word: "Transform", meaning: "To change completely", example: "The city has been transformed." },
      { word: "Publish", meaning: "To make available to public", example: "The book was published last year." },
      { word: "Influence", meaning: "To affect or change", example: "She was influenced by her teacher." },
      { word: "Recognize", meaning: "To identify or acknowledge", example: "He was recognized for his work." },
      { word: "Design", meaning: "To plan and create", example: "The building was designed by a famous architect." },
    ],
    dialogue: [
  ...
  "c1-1": {
    ...
    vocabulary: [
      { word: "Nuance", meaning: "A subtle difference in meaning", example: "There's an important nuance between the two terms." },
      { word: "Allegedly", meaning: "Claimed but not proven", example: "He allegedly committed the crime." },
      { word: "Implications", meaning: "Possible effects or consequences", example: "The implications of this policy are far-reaching." },
      { word: "Ambiguous", meaning: "Having more than one meaning", example: "The statement was rather ambiguous." },
      { word: "Elaborate", meaning: "To explain in more detail", example: "Could you elaborate on that point?" },
      { word: "Substantial", meaning: "Large in amount or importance", example: "There has been substantial progress." },
      { word: "Undermine", meaning: "To weaken gradually", example: "This could undermine public trust." },
      { word: "Tentative", meaning: "Not certain or fixed", example: "We've made a tentative agreement." },
      { word: "Pragmatic", meaning: "Dealing with things practically", example: "We need a pragmatic approach." },
      { word: "Compelling", meaning: "Very convincing", example: "She made a compelling argument." },
    ],
    dialogue: [
  ...
  "c2-1": {
    ...
    vocabulary: [
      { word: "Rhetoric", meaning: "The art of persuasive speaking/writing", example: "His rhetoric was powerful and moving." },
      { word: "Juxtaposition", meaning: "Placing contrasting things together", example: "The juxtaposition of wealth and poverty was striking." },
      { word: "Eloquent", meaning: "Fluent and persuasive in speech", example: "She gave an eloquent speech." },
      { word: "Succinct", meaning: "Brief and clearly expressed", example: "Keep your answer succinct." },
      { word: "Verbose", meaning: "Using more words than needed", example: "The report was unnecessarily verbose." },
      { word: "Paradox", meaning: "A statement that contradicts itself but reveals truth", example: "Less is more — a classic paradox." },
      { word: "Irony", meaning: "Saying the opposite of what you mean", example: "The fire station burned down — that's irony." },
      { word: "Connotation", meaning: "An idea suggested by a word beyond its literal meaning", example: "'Home' has warm connotations." },
      { word: "Register", meaning: "Level of formality in language", example: "Academic writing uses a formal register." },
      { word: "Discourse", meaning: "Written or spoken communication", example: "Political discourse shapes public opinion." },
    ],
    dialogue: [
