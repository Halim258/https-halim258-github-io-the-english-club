    ...
    courses: [
      {
        ...
        description: "Start from zero — alphabet, greetings, numbers, and self-introduction.",
        topics: ["Alphabet", "Greetings", "Numbers", "Present Tense"],
        modules: [
          { week: "Week 1", title: "Alphabet & Pronunciation", goal: "Pronounce Spanish letters and sounds correctly.", activities: ["Alphabet chant", "Vowel sounds a-e-i-o-u", "Rolling the R"] },
          { week: "Week 2", title: "Greetings & Introductions", goal: "Meet people and introduce yourself.", activities: ["Hola, ¿cómo estás?", "Me llamo…", "Formal vs informal usted/tú"] },
          { week: "Week 3", title: "Numbers, Days & Time", goal: "Talk about numbers, dates and time.", activities: ["Numbers 1–100", "Days & months", "Telling the time"] },
          { week: "Week 4", title: "Present Tense of Ser/Estar", goal: "Describe yourself and things around you.", activities: ["Ser vs Estar", "Adjective agreement", "Simple dialogues"] },
        ],
      },
      {
        name: "Spanish A2 — Elementary",
        description: "Past tense, daily routines, food, shopping, and short conversations.",
        topics: ["Past Tense", "Routines", "Food", "Shopping"],
        modules: [
          { week: "Week 1", title: "Daily Routines", goal: "Describe your day using reflexive verbs.", activities: ["Me levanto, me ducho…", "Adverbs of frequency", "Routine dialogue"] },
          { week: "Week 2", title: "Preterite Past Tense", goal: "Talk about finished actions in the past.", activities: ["Regular -ar/-er/-ir verbs", "Common irregulars", "'Last weekend' storytelling"] },
          { week: "Week 3", title: "Food & Restaurants", goal: "Order food and shop for groceries.", activities: ["Menu vocab", "Restaurant role-play", "Market bargaining"] },
          { week: "Week 4", title: "Shopping & City", goal: "Navigate shops and ask for prices.", activities: ["¿Cuánto cuesta?", "Clothes & sizes", "Directions in the city"] },
        ],
      },
      {
        name: "Spanish B1 — Intermediate",
        description: "Subjunctive intro, opinions, travel, work, and cultural topics.",
        topics: ["Subjunctive", "Opinions", "Travel", "Culture"],
        modules: [
          { week: "Week 1", title: "Imperfect vs Preterite", goal: "Choose the right past tense fluently.", activities: ["Storytelling contrast", "Cuando era niño…", "Reading a short story"] },
          { week: "Week 2", title: "Future & Conditional", goal: "Talk about plans, dreams, and hypotheticals.", activities: ["Regular future forms", "Conditional 'me gustaría…'", "Dream trip discussion"] },
          { week: "Week 3", title: "Subjunctive Introduction", goal: "Use present subjunctive in real contexts.", activities: ["Espero que…", "Es importante que…", "Advice role-play"] },
          { week: "Week 4", title: "Culture & Opinions", goal: "Give opinions on cultural topics.", activities: ["Hispanic music", "Latin cinema", "Debate: costumbres"] },
        ],
      },
      {
        name: "Spanish B2 — Upper Intermediate",
        description: "Complex grammar, debates, news, literature, and fluent conversation.",
        topics: ["Advanced Grammar", "Debates", "News", "Literature"],
        modules: [
          { week: "Week 1", title: "Advanced Subjunctive", goal: "Use past subjunctive and 'si' clauses.", activities: ["Si tuviera…", "Ojalá + past", "Hypothetical storytelling"] },
          { week: "Week 2", title: "News & Media", goal: "Read and discuss Spanish news articles.", activities: ["Headline decoding", "Article summary", "News debate"] },
          { week: "Week 3", title: "Literature Bites", goal: "Read short passages by Neruda, Márquez.", activities: ["Poem analysis", "Micro-story reading", "Written response"] },
          { week: "Week 4", title: "Debate & Presentation", goal: "Argue a point in Spanish for 3 minutes.", activities: ["Debate prep", "Counter-arguments", "Live class debate"] },
        ],
      },
      {
        name: "Spanish Conversation Club",
        description: "Weekly live speaking practice on real-world topics with guided prompts.",
        topics: ["Speaking", "Fluency", "Role Play"],
        modules: [
          { week: "Week 1", title: "Small Talk", goal: "Handle greetings and everyday chat.", activities: ["Ice-breaker questions", "Weather & weekend", "1-on-1 practice"] },
          { week: "Week 2", title: "Opinions & Preferences", goal: "Share what you like and why.", activities: ["Me gusta / no me gusta", "Justify preferences", "Group discussion"] },
          { week: "Week 3", title: "Role Play Scenarios", goal: "Handle real-life situations in Spanish.", activities: ["At the doctor", "At the airport", "Hotel check-in"] },
          { week: "Week 4", title: "Storytelling", goal: "Tell a 2-minute personal story.", activities: ["Story planning", "Past tenses in action", "Live storytelling round"] },
        ],
      },
      {
        name: "Spanish for Travel",
        description: "Practical phrases for airports, hotels, restaurants, and directions across Spain & Latin America.",
        topics: ["Travel Phrases", "Hotels", "Restaurants", "Directions"],
        modules: [
          { week: "Week 1", title: "Airport & Transport", goal: "Navigate airports and public transport.", activities: ["Boarding vocabulary", "Taxi & bus phrases", "Ticket buying role-play"] },
          { week: "Week 2", title: "Hotels & Accommodation", goal: "Book and check in to a hotel.", activities: ["Reservation call", "Check-in dialogue", "Reporting a problem"] },
          { week: "Week 3", title: "Restaurants & Food", goal: "Order and enjoy meals confidently.", activities: ["Menu reading", "Ordering & paying", "Dietary restrictions"] },
          { week: "Week 4", title: "Directions & Emergencies", goal: "Ask for help, directions and handle emergencies.", activities: ["Street directions", "Medical basics", "Police & lost items"] },
        ],
      },
    ],
  },
