...
export const categories: Category[] = [
  ...
  },
  {
    ...
    courses: [
      ...
      { name: "The Perfect Recorder Method", description: "A complete beginner recorder pathway: setup, posture, rhythm, fingering, rounds, and a first recital.", topics: ["20 Lessons", "B–F' Notes", "Rhythm", "Performance"] },
    ],
  },
  {
    icon: Newspaper,
  ...
  },
  {
    icon: HeartPulse,
    emoji: "📚",
    title: "علاج التخاطب — مبني على المراجع",
    slug: "arabic-speech-therapy-books",
    color: "from-teal-500/10 to-emerald-500/5",
    iconBg: "bg-teal-500/15",
    image: speechTherapyArImg,
    description:
      "منهج علاجي شامل مبني على 10 كتب مرجعية في التخاطب — 60 درسًا مصمم بأسلوب مرح للأطفال، عملي للأهل والأخصائيين، لتصحيح اضطرابات النطق واللغة والصوت والطلاقة.",
    courses: [
      { name: "كتاب 1 — اضطرابات التواصل بين النظرية والتطبيق", description: "مفهوم التواصل، أنواع الاضطرابات، الأسباب، التقييم، التدخل المبكر، ودور الأسرة.", topics: ["Communication", "Assessment", "Early Intervention", "Family Role"] },
      { name: "كتاب 2 — الاضطرابات الصوتية", description: "أسباب البحّة، عقيدات الحبال، تدريبات التنفس، والحماية الصوتية للأطفال.", topics: ["Voice", "Nodules", "Breathing", "Vocal Hygiene"] },
      { name: "كتاب 3 — مشكلات الكلام واللجلجة", description: "التمييز بين اللجلجة الطبيعية والمرضية، تقنيات العلاج، دور المدرسة، وبناء ثقة الطفل.", topics: ["Stuttering", "Fluency", "Confidence", "School Support"] },
      { name: "كتاب 4 — اضطرابات النطق والكلام", description: "أنواع أخطاء النطق (إبدال، حذف، إضافة، تشويه)، تدريب المخارج، الأصوات الصعبة، والتعميم.", topics: ["Articulation", "Phonemes", "R/S/Sh", "Generalization"] },
      { name: "كتاب 5 — مشكلات التواصل اللغوي", description: "اللغة الاستقبالية والتعبيرية، بناء المفردات، تكوين الجمل، الحوار، وسرد القصص.", topics: ["Receptive", "Expressive", "Vocabulary", "Narrative"] },
      { name: "كتاب 6 — النيروسيكولوجيا واللغة", description: "الدماغ واللغة، الانتباه، الذاكرة السمعية، المرونة الدماغية، واضطرابات النمو العصبي.", topics: ["Brain", "Attention", "Memory", "Neurodevelopment"] },
      { name: "كتاب 7 — مهارات الاتصال اللغوي", description: "الاستماع الفعال، التحدث المؤثر، القراءة، الكتابة، التلخيص، والحوار البنّاء.", topics: ["Listening", "Speaking", "Reading", "Writing"] },
      { name: "كتاب 8 — مدخل علم اللغة واضطرابها", description: "مستويات اللغة (صوت، صرف، نحو، دلالة، تداول)، الوعي الصوتي، واشتقاق الكلمات.", topics: ["Phonology", "Morphology", "Syntax", "Pragmatics"] },
      { name: "كتاب 9 — الاضطرابات النطقية الفونولوجية", description: "الفرق بين اضطراب النطق والفونولوجي، العمليات الفونولوجية، ونماذج العلاج المعتمدة.", topics: ["Phonological", "Processes", "Minimal Pairs", "Cycles"] },
      { name: "كتاب 10 — تنمية المهارات اللغوية لأطفال ما قبل المدرسة", description: "معالم اللغة من 3 إلى 6 سنوات، أنشطة يومية، شراكة المعلمة، وتأهيل الطفل للمدرسة.", topics: ["Preschool", "Milestones", "Activities", "School Ready"] },
    ],
  },
  {
    icon: Palette,
