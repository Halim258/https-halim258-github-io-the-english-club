...
const lessonsPlan: RecorderLesson[] = [
  ...
  { title: "The Upper Note F'", description: "Reach the highest note in this pathway and practise controlled air, accurate fingering, and a confident release.", focus: "upper F, high register, air control, release", note: "F'", technique: "Upper F needs focused air and precise fingering. Keep the sound light, then release the note without a sudden stop.", practice: ["Move E'–F'–E' slowly and listen for a clear pitch.", "Hold F' for two beats with relaxed shoulders.", "Add F' to a short phrase only after the fingering feels secure."], tune: "The top of the beginner range" },
