...
const SUB_LEVEL_GROUPS: Record<string, { code: string; title: string; from: number; to: number }[]> = {
  ...
  "hospitality": [
    { code: "A2.1", title: "Guest Service Foundations", from: 1, to: 5 },
    { code: "A2.2", title: "Rooms, Dining & Directions", from: 6, to: 10 },
    { code: "B1.1", title: "Events, Safety & Guest Care", from: 11, to: 15 },
    { code: "B1.2", title: "Reviews, Sales & Guest Journeys", from: 16, to: 20 },
  ],
  "healthcare": [
    { code: "B1.1", title: "Patient Communication", from: 1, to: 5 },
    { code: "B1.2", title: "Care, Medication & Follow-up", from: 6, to: 10 },
    { code: "B2.1", title: "Clinical Team Communication", from: 11, to: 15 },
    { code: "B2.2", title: "Safety, Ethics & Patient Journey", from: 16, to: 20 },
  ],
  "it-english": [
    { code: "B1.1", title: "Support & Product Foundations", from: 1, to: 5 },
    { code: "B1.2", title: "Documentation, Security & Data", from: 6, to: 10 },
    { code: "B2.1", title: "Engineering Collaboration", from: 11, to: 15 },
    { code: "C1.1", title: "Technical Leadership & Delivery", from: 16, to: 20 },
  ],
  "a1": [
...
function LevelLessons({ levelId, levelLabel }: { levelId: string; levelLabel: string }) {
  ...
  return (
    <div className="container mx-auto max-w-3xl px-4 py-8 md:py-10">
      ...
      {levelId === "phonics" && (
        <FadeInUp>
          <div className="mb-5 flex flex-col gap-3 rounded-2xl border border-primary/30 bg-gradient-to-br from-primary/10 to-accent/5 p-4 md:flex-row md:items-center md:justify-between">
            <div>
              <p className="text-xs font-semibold uppercase tracking-widest text-primary">Not sure where to start?</p>
              <p className="mt-1 text-sm text-muted-foreground">
                Take the 15-question phonics diagnostic and we'll place you in the right stage.
              </p>
            </div>
            <Button asChild className="shrink-0 rounded-full font-semibold">
              <Link to="/phonics-test">
                Take the diagnostic quiz <ArrowRight className="ml-1 h-4 w-4" />
              </Link>
            </Button>
          </div>
        </FadeInUp>
...
export default function Courses() {
  ...
  if (levelId && !window.location.pathname.match(/\/courses\/[^/]+\/\d+/)) {
    ...
    const specializedLevelLabels: Record<string, string> = {
      ...
      legal: "Legal English",
      hospitality: "Hospitality English — A2–B1",
      "customer-service": "Customer Service English — A2–B1",
      conversation: "Conversation Practice",
      "social-media": "English for Social Media",
      healthcare: "English for Healthcare — B1–B2",
      ...
      "de-a1": "Deutsch A1 — Goethe-Zertifikat",
      "de-a2": "Deutsch A2 — Goethe-Zertifikat",
      "de-b1": "Deutsch B1 — Goethe-Zertifikat",
      "de-b2": "Deutsch B2 — Goethe-Zertifikat",
      "de-c1": "Deutsch C1 — Goethe-Zertifikat",
      "de-c2": "Deutsch C2 — Großes Deutsches Sprachdiplom",
      "it-a1": "Italiano A1 — CILS/CELI",
      "it-a2": "Italiano A2 — CILS/CELI",
      "it-b1": "Italiano B1 — CILS/CELI",
      "it-b2": "Italiano B2 — CILS/CELI",
      "it-c1": "Italiano C1 — CILS/CELI",
      "it-c2": "Italiano C2 — CILS/CELI",
      ...
      "ar-sp-1": "علاج التخاطب — كتاب 1: اضطرابات التواصل",
      "ar-sp-2": "علاج التخاطب — كتاب 2: الاضطرابات الصوتية",
      "ar-sp-3": "علاج التخاطب — كتاب 3: اللجلجة والتلعثم",
      "ar-sp-4": "علاج التخاطب — كتاب 4: اضطرابات النطق",
      "ar-sp-5": "علاج التخاطب — كتاب 5: التواصل اللغوي",
      "ar-sp-6": "علاج التخاطب — كتاب 6: الدماغ واللغة",
      "ar-sp-7": "علاج التخاطب — كتاب 7: مهارات الاتصال",
      "ar-sp-8": "علاج التخاطب — كتاب 8: علم اللغة",
      "ar-sp-9": "علاج التخاطب — كتاب 9: الفونولوجيا",
      "ar-sp-10": "علاج التخاطب — كتاب 10: قبل المدرسة",
      "ar-draw-1": "الرسم — المرحلة الأولى: أساسيات الرسم",
      "ar-draw-2": "الرسم — المرحلة الثانية: الأشياء البسيطة",
      "ar-draw-3": "الرسم — المرحلة الثالثة: الشخصيات والوجوه",
      "ar-draw-4": "الرسم — المرحلة الرابعة: الطبيعة والمناظر",
      "ar-draw-5": "الرسم — المرحلة الخامسة: الظل والإضاءة",
      "ar-draw-6": "الرسم — المرحلة السادسة: الإبداع والمشاريع",
      "ar-mus-1": "الموسيقى — المستوى الأول: الأساسيات",
      "ar-mus-2": "الموسيقى — المستوى الثاني: الإيقاع",
      "ar-mus-3": "الموسيقى — المستوى الثالث: الغناء",
      "ar-mus-4": "الموسيقى — المستوى الرابع: العزف الأساسي",
      "ar-mus-5": "الموسيقى — المستوى الخامس: القراءة الموسيقية",
      "ar-mus-6": "الموسيقى — المستوى السادس: الهارموني والتأليف",
    };
