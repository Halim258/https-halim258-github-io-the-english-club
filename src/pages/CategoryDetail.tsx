...
const courseLevelMap: Record<string, string> = {
  ...
  "Español A1.1 — Getting Started": "es-a1",
  "Español A1.2 — Everyday Life": "es-a1",
  "Español A1.3 — Living and Traveling": "es-a1",
  "Español A2.1 — Personal Experiences": "es-a2",
  "Español A2.2 — Society and Services": "es-a2",
  "Español A2.3 — Life Events": "es-a2",
  "Español B1.1 — Communication": "es-b1",
  "Español B1.2 — Lifestyle": "es-b1",
  "Español B1.3 — Culture and Society": "es-b1",
  "Español B1.4 — Opinions and Discussions": "es-b1",
  "Español B2.1 — Modern Society": "es-b2",
  "Español B2.2 — Professional Spanish": "es-b2",
  "Español B2.3 — Critical Thinking": "es-b2",
  "Español B2.4 — Academic and Cultural Spanish": "es-b2",
  "Español C1.1 — Advanced Communication": "es-c1",
  "Español C1.2 — Academic and Professional Language": "es-c1",
  "Español C1.3 — Business and Leadership": "es-c1",
  "Español C1.4 — Literature and Arts": "es-c1",
  "Español C1.5 — Global Issues": "es-c1",
  "Español C1.6 — DELE C1 Preparation": "es-c1",
  ...
  // Arabic Speech Therapy Books — علاج التخاطب مبني على المراجع
  "كتاب 1 — اضطرابات التواصل بين النظرية والتطبيق": "ar-sp-1",
  "كتاب 2 — الاضطرابات الصوتية": "ar-sp-2",
  "كتاب 3 — مشكلات الكلام واللجلجة": "ar-sp-3",
  "كتاب 4 — اضطرابات النطق والكلام": "ar-sp-4",
  "كتاب 5 — مشكلات التواصل اللغوي": "ar-sp-5",
  "كتاب 6 — النيروسيكولوجيا واللغة": "ar-sp-6",
  "كتاب 7 — مهارات الاتصال اللغوي": "ar-sp-7",
  "كتاب 8 — مدخل علم اللغة واضطرابها": "ar-sp-8",
  "كتاب 9 — الاضطرابات النطقية الفونولوجية": "ar-sp-9",
  "كتاب 10 — تنمية المهارات اللغوية لأطفال ما قبل المدرسة": "ar-sp-10",
  // Arabic Drawing — دورة الرسم
  "المرحلة الأولى — أساسيات الرسم": "ar-draw-1",
  "المرحلة الثانية — رسم الأشياء البسيطة": "ar-draw-2",
  "المرحلة الثالثة — الشخصيات والوجوه": "ar-draw-3",
  "المرحلة الرابعة — الطبيعة والمناظر": "ar-draw-4",
  "المرحلة الخامسة — الظل والإضاءة": "ar-draw-5",
  "المرحلة السادسة — الإبداع والمشاريع": "ar-draw-6",
  // Arabic Music — منهج الموسيقى
  "المستوى الأول — أساسيات الموسيقى": "ar-mus-1",
  "المستوى الثاني — الإيقاع": "ar-mus-2",
  "المستوى الثالث — الغناء": "ar-mus-3",
  "المستوى الرابع — العزف الأساسي": "ar-mus-4",
  "المستوى الخامس — القراءة الموسيقية": "ar-mus-5",
  "المستوى السادس — الهارموني والتأليف": "ar-mus-6",
};
