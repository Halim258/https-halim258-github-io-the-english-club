...
function BooksTab({ collections }: { collections: Coll }) {
  ...
  const TOPICS = [
    ...
    { label: "Bedtime", value: "bedtime stories" },
    ...
    { label: "Drama", value: "drama plays" },
    { label: "Biography", value: "biography" },
    { label: "Travel", value: "travel" },
    { label: "Science", value: "science" },
    { label: "Religion", value: "religion" },
    { label: "Humor", value: "humor comedy" },
    { label: "War", value: "war military" },
    { label: "Nature", value: "nature wildlife" },
    { label: "Cooking", value: "cooking recipes" },
