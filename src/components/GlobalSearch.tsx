...
const pages = [
  ...
  { path: "/courses/egyptian-public", label: "Public School English", icon: GraduationCap, keywords: "egyptian ministry government school workbook exam revision" },
  { path: "/courses/egyptian-national", label: "National School English", icon: GraduationCap, keywords: "national school grammar writing reading term exams" },
  { path: "/courses/egyptian-international", label: "International School English", icon: GraduationCap, keywords: "international school british american ib literature academic writing" },
